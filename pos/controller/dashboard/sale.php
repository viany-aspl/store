...
class ControllerDashboardSale extends Controller {
	...
	public function index() {
		...
		$sale_total = $this->model_report_sale->getTotalSales(array('filter_store'=>$this->user->getStoreId()));
		...
		if ($sale_total > 1000000000000) {
			...
			$data['total'] = round($sale_total);
                ...
                $credit_total = $this->model_report_sale->getTotalCredit(array('filter_store'=>$this->user->getStoreId()));
