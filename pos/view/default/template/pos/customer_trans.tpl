 ...
 <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <table class="table table-bordered mb-0">
                            ...
                            <tr>
                                <td><?php echo $a; ?></td>
                                <td><a href="#" onclick="return open_model(<?php echo $product['order_id']; ?>);"><?php echo $product['invoice_prefix'].$product['invoice_no']; ?></a></td>
									<td><?php echo date('Y-m-d',$product['date_added']->sec); ?></td>
									<td><?php echo RUPPE_SIGN.number_format((float)$product['total'], 0, '.', ''); ?></td>
									<td><?php echo RUPPE_SIGN.number_format((float)$product['discount'], 0, '.', ''); ?></td>
									<td><?php echo RUPPE_SIGN.number_format((float)$product['cash'], 0, '.', ''); ?></td>
                                <td><?php echo RUPPE_SIGN.number_format((float)$product['credit'], 0, '.', ''); ?></td>
