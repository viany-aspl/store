                                ...
                                <div class="actions">
                                    <div class="dropdown actions__item">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="index.php?route=pos/total_credit/pay_for_credit&mobile_number=<?php echo ($customer['telephone']); ?>&aadhar=<?php echo ($customer['aadhar']); ?>&name=<?php echo ($customer['firstname']." ".$customer['lastname']); ?>&pagetittle=Pay for Credit">Update Credit</a>
                                            <a class="dropdown-item" href="index.php?route=pos/report/customer_credit_trans&mobile_number=<?php echo ($customer['telephone']); ?>&aadhar=<?php echo ($customer['aadhar']); ?>&name=<?php echo ($customer['firstname']." ".$customer['lastname']); ?>&token=<?php echo $token; ?>&credit=<?php echo ($customer['credit']); ?>&customer_id=<?php echo ($customer['customer_id']); ?>&view_type=credit&pagetittle=Customer transactions">Transactions Details</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
function send_email() 
	{
		url = 'index.php?route=pos/total_credit/email&token=<?php echo $token; ?>';
                            ...
                            '<div class="groups__item">'+
                                ...
                                '<div class="actions">'+
                                    '<div class="dropdown actions__item">'+
                                        '<i class="zmdi zmdi-more-vert" data-toggle="dropdown"></i>'+
                                        '<div class="dropdown-menu dropdown-menu-right">'+
                                            '<a class="dropdown-item" href="index.php?route=pos/total_credit/pay_for_credit&mobile_number='+item['label']+'&aadhar='+item['aadhar']+'&name='+item['name']+'">Update Credit</a>'+
                                            '<a class="dropdown-item" href="#">Transactions Details</a>'+
                                        '</div>'+
                                   '</div>'+
                                '</div>'+
                            '</div>'+
