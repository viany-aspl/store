            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><a href="<?php echo $user_group['menu_edit']; ?>" data-toggle="tooltip" title="Menu Configuration" class="btn btn-danger"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
