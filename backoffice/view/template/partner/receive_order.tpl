  ...
  <div class="panel panel-default">
	...
	<form action="<?php echo $action . "&order_id=".$order_id; ?>" method="post" enctype="multipart/form-data" id="form-order-receive" class="form-horizontal">
		<table class="table table-bordered">
	      ...
	      <td class="text-left" style="widht:20%">Ware House</td>
            ...
            <tr>
			  ...
			  <td class="text-left" style="width: 20%;">
                              ...
                              <select class="form-control" id="ware_house_<?php echo $a; ?>" name="ware_houses[]">
                                    ...
                                    <?php foreach($ware_houses as $ware_house){ ?>
					<option value="<?php echo $ware_house['store_id']; ?>" ><?php echo $ware_house['name']; ?></option>
				<?php } ?>
				</select>
		...
		?>
			...
			<td class="text-right" colspan="5" style="width: 100%;"><span class="input-group-btn">
                          <button  <?php if($order_information['order_info']['order_sup_send']!='0000-00-00'){ ?> disabled="disabled" <?php } ?> type="button" id="button-filter" class="btn btn-primary pull-right" onclick="return submit_form();">
...
{ //alert('kkk');
    ...
    ?>
           ...
           if(product_sent_quantity=="")
           {
              ...
              errrr='Please enter Sent quantity ';
              return false;
           }
           if(ware_house=="")
           {
              alertify.error('Please Select Ware House '); 
              errrr='Please Select Ware House';
              $("#ware_house_"+<?php echo $a; ?>).focus();
              return false;
           }
           
    var form=$("#form-order-receive");
    var url = 'index.php?route=partner/purchase_order/check_ware_house_quantity_by_account&token=<?php echo $token; ?>';
