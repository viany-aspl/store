...
<div class="form-group required">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="bankaddress" value="<?php if(isset($bankaddress)) echo $bankaddress; ?>" placeholder="<?php echo "Address"; ?>" id="input-BankAddress" class="form-control" />
<?php if (isset($_SESSION['error_address'])) { ?>
 ...
 <div class="col-sm-10">
 <input type="text" name="location" value="<?php if(isset($location)) echo $location;?>" placeholder="<?php echo "Location"; ?>" id="input-location" class="form-control" />
 ...
 <div class="col-sm-10">
 <input type="text" name="gst" value="<?php if(isset($gst)) echo $gst;?>" placeholder="<?php echo "GST"; ?>" id="input-gst" class="form-control" />
 ...
 <div class="col-sm-10">
 <input type="text" name="pan" value="<?php if(isset($pan)) echo $pan;?>" placeholder="<?php echo "PAN NO"; ?>" id="input-address" class="form-control" />
