            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
				  ...
				  <td class="text-left">Supplier/Ware House / OTP</td>
              ...
              <tbody>
				...
				?>
						<tr>
							...
							<td class="text-left"><?php //echo $order['order_status_id'];
                                                            if($order['receive_bit']==0)
                                                            { 
                                                                if($order['canceled_message']!='')
                                                                {
                                                                    echo "Canceled";
                                                                }
																else if($order['order_status_id']==2)
																{
																	echo "Pending/Appproved";  
																}
                                                                else 
                                                                {
                                                                   echo "pending";  
							...
							<td class="text-left">
                                                            <?php 
                                                            //print_r($order);
                                                            if($order['po_receive_details']['supplier_quantity'] == 0) 
                                                            {
                                                            if($order['canceled_message']!='')
                                                            {    
                                                            ?>
                                                            <a class="btn btn-info" href="<?php echo $view . '&order_id='.$order['id']; ?>" data-toggle="tooltip" title="View Requisition" class="btn btn-primary">
                                                               <i class="fa fa-eye"></i>
                                                            </a>
                                                            <?php 
                                                            }
                                                               ...
                                                               ?> 
                                                            <a class="btn btn-info" href="<?php echo $view . '&order_id='.$order['id']; ?>" data-toggle="tooltip" title="Confirm Requisition" class="btn btn-primary">
                                                            ...
                                                            { ?>
                                                            <a href="<?php echo $view . '&order_id='.$order['id']; ?>" data-toggle="tooltip" title="<?php echo "View"; ?>" style="margin-left: 5px;" class="btn btn-info">
                                                                <i class="fa fa-eye"></i>
                                                            </a>
                                                            <?php } ?>
...
$('#button-download').on('click', function() {
	url = 'index.php?route=purchase/purchase_order/download_excel&token=<?php echo $token; ?>';
