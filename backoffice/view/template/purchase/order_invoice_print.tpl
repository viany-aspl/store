      ...
      <br/>
		...
		Purchase Order No : <?php echo $order_id; ?>
                ...
                Warehouse : 
                    ...
                    <?php 
                    echo $order_information['order_info']['store_name'];
		...
		<table class="table"  id="print_table" border="0">
          <thead>
                <tr style="background-color: #C4D5DE;">
                          <th class="text-left" style="width: 11.11%;">S.No.</th>
                          <th class="text-left" style="width: 11.11%;">Product Name</th>
                          <th class="text-left" style="width: 11.11%;">HSN</th>
			  <th class="text-left" style="width: 11.11%;">Rate</th>
			  <th class="text-left" style="width: 11.11%;">Tax Type</th>
                          <th class="text-left" style="width: 11.11%;">Tax (Per Unit)</th>
		...
		?>
          ...
          <tr>
              <td colspan="7" class="text-right"  id="set_colspan" ><b>Grand Total:</b></td>
                    <td colspan="1" class ="text-left" id="td_grand_total"><?php if($grand_total == 0) echo ''; else echo number_format((float)$grand_total, 2, '.', ''); ?></td>
			</tr>
</tbody>
        </table>
...
<link href="view/javascript/bootstrap/less/bootstrap.less" rel="stylesheet/less"><style id="less:shop-admin_shop-view-javascript-bootstrap-less-bootstrap" type="text/css">/*! normalize.css v3.0.1 | MIT License | git.io/normalize */
html {
...
@font-face {
  ...
  src: url('http://localhost/shop/admin_shop/view/javascript/bootstrap/fonts/glyphicons-halflings-regular.eot');
  src: url('http://localhost/shop/admin_shop/view/javascript/bootstrap/fonts/glyphicons-halflings-regular.eot?#iefix') format('embedded-opentype'), url('http://localhost/shop/admin_shop/view/javascript/bootstrap/fonts/glyphicons-halflings-regular.woff') format('woff'), url('http://localhost/shop/admin_shop/view/javascript/bootstrap/fonts/glyphicons-halflings-regular.ttf') format('truetype'), url('http://localhost/shop/admin_shop/view/javascript/bootstrap/fonts/glyphicons-halflings-regular.svg#glyphicons_halflingsregular') format('svg');
}
.glyphicon {
  position: relative;
  top: 1px;
...
.has-success .form-control:focus {
  border-color: #75a74d;
  -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 6px #c4dbb2;
  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 6px #c4dbb2;
}
...
.has-warning .form-control:focus {
  border-color: #e56c0e;
  -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 6px #f9c093;
  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 6px #f9c093;
}
...
.has-error .form-control:focus {
  border-color: #f23b3b;
  -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 6px #fbcbcb;
  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 6px #fbcbcb;
}
