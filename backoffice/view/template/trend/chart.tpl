<div class="panel panel-default col-lg-6">
  <div class="panel-heading">
    ...
    <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Order trend</h3>
  </div>
...
$('#range a').on('click', function(e) {
	...
	$.ajax({
		type: 'get',
		url: 'index.php?route=trend/chart/storechart&token=<?php echo $token; ?>&range=' + $(this).attr('href'),
		dataType: 'json',
...
$('#range-sale a').on('click', function(e) {
	...
	$.ajax({
		type: 'get',
		url: 'index.php?route=trend/chart/productchart&token=<?php echo $token; ?>&range=' + $(this).attr('href'),
		dataType: 'json',
		success: function(json) {
