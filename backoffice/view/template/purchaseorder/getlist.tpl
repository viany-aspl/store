  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <a href="index.php?route=purchaseorder/suppliercreditposting/add&token=<?php echo $token; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
      ...
      <div class="panel-body">
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                <label class="control-label" for="input-status">Supplier</label>
                <select style="width:100%;" name="filter_supplier" id="filter_supplier" class="select2 form-control">
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=purchaseorder/suppliercreditposting/getlist&token=<?php echo $token; ?>';
