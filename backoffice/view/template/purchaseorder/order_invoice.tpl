...
<div id="content">
  ...
  <div class="panel panel-default" id = "print_div">
	...
	<?php }?>
                            ...
                            PAN : <span id="ship_to_pan"><?php if(!empty($created_po)){ echo $store_to_data[4];  }  ?></span> <br />
                            GSTN : <span id="ship_to_gstn"><?php if(!empty($created_po)){ echo $store_to_data[5];  }  ?></span><br />
                            Credit Limit : <span id="ship_to_creditlimit"><?php if(!empty($created_po)){ echo $store_to_data[6];  }  ?></span> <br />
                            Current Credit : <span id="ship_to_currentcredit"><?php if(!empty($created_po)){ echo $store_to_data[7];  }  ?></span><br />
							Current Outstanding : <span id="ship_to_currentoutstanding"><?php if(!empty($created_po)){ echo $store_to_data[8];  }  ?></span><br />
   ...
   if((store_id!="") && (store_id!="0"))
    {
	  ...
	  var current_outstanding=(parseFloat(data[6])-parseFloat(data[7])).toFixed(2);//data[8]
	  //alert(current_outstanding); 
                $("#ship_to_currentoutstanding").html(current_outstanding);
