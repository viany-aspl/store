...
<div id="content">
  <div class="page-header">
    <div class="container-fluid"> 
      <h1>DSCL Card Summary Report</h1>
  </div>
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-list"></i>DSCL Card Summary Report</h3>
	...
	<td class="text-left">Verify</td> 
	  <td class="text-left">Pending Approval</td>				
			...
			<?php //print_r($orders); ?>
              ...
              <tr>
			    <td class="text-left"><?php if($order['FACTORY']=='01'){ echo "AJBAPUR"; } elseif($order['FACTORY']=='02'){ echo "RUPAPUR"; } elseif($order['FACTORY']=='03'){ echo "HARIYAWAN"; } elseif($order['FACTORY']=='04'){ echo "LONI"; } ?></td>				
