  ...
  <div class="page-header">
    <div class="container-fluid">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="<?php echo $breadcrumb['href']; ?>">Category Add</a></li>
        <?php } ?>
      </ul>
    </div>
  </div>
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> Category Add</h3>
      </div>
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-store" class="form-horizontal">
            <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-meta-title">Category</label>
                <div class="col-sm-10">
                    <input type="text" name="category_name" value="" placeholder="Add category" id="category_name" class="form-control"  required="required" />
