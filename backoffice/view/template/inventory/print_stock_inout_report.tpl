          ...
          <table class="table table-bordered">
            ...
            <tbody>
				...
				<tr>
					...
					<!--<td><?php  ?></td>-->
					<td><?php if(isset($inout_detail['purchase_quantity'])){ echo $inout_detail['purchase_quantity']; } ?></td>
					<td><?php if(isset($inout_detail['sales_quantity'])){ echo $inout_detail['sales_quantity']; } ?></td>
				</tr>
				<?php } ?>
            </tbody>
          </table>
