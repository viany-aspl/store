...
<div id="content">
  ...
  <div class="panel panel-default" id = "print_div">
                  ...
                  <table class="table table-bordered">
                    <tr>
                        ...
                        <td class="col-sm-6">
                            ...
                            <select onchange="return get_to_store_data(this.value);" required name="store_to" id="store_to" style="float: right;width: 80%;width: 57%;height: 29px;padding: 4px;" class="form-control">
	...
	<?php }?>
                            ...
                            Pan Card : <span id="to_store_pan"><?php if(!empty($created_po)){ echo $store_to_data[4];  }  ?></span> <br />
                      ...
                      <tr>
                          <td class="col-sm-6">
                              <strong>Ship to: </strong>
                               <?php if(empty($created_po)){ ?> 
                            <select onchange="return get_ship_to_data(this.value);" required name="ship_to" id="ship_to" style="float: right;width: 80%;width: 57%;height: 29px;padding: 4px;" class="form-control">
                    <option value="">SELECT</option>
                    <?php foreach($order_information['to_stores'] as $ware_houses)
                    {
                    ?>
	...
	<?php }?>
                              <br /><br />
                            Name : <span id="ship_to_name"><?php if(!empty($created_po)){ echo $store_to_data[0];  }  ?></span> <br />
                            Address : <span id="ship_to_address"><?php if(!empty($created_po)){ echo $store_to_data[1];  }  ?></span> <br />
                            Phone No : <span id="ship_to_phone"><?php if(!empty($created_po)){ echo $store_to_data[2];  }  ?></span><br />
                            Email Id : <span id="ship_to_email"><?php if(!empty($created_po)){ echo $store_to_data[3];  }  ?></span> <br />
		Pan Card : <span id="ship_to_pan"><?php if(!empty($created_po)){ echo $store_to_data[4];  }  ?></span> <br />
		GSTN : <span id="ship_to_gstn"><?php if(!empty($created_po)){ echo $store_to_data[5];  }  ?></span> <br />
                          ...
                          <td>
                              ...
                              <?php if(empty($created_po)){ ?> 
                              <select required name="ware_house" id="ware_house" onchange="return enable_product_name(this.value);" style="float: right;width: 80%;width: 57%;height: 29px;padding: 4px;" class="form-control">
                    <option value="">SELECT</option>
                    <?php foreach($order_information['ware_houses'] as $ware_houses)
			{
                    ?>
                    <option <?php if($ware_house==$ware_houses['store_id']){?> selected="selected"<?php }  ?> value="<?php echo $ware_houses['store_id']; ?>"><?php echo $ware_houses['name']; ?></option> 
                    <?php
	...
	<?php } ?>
		  ...
		  <br />
		  Purchase Order/ Referance ID: <input required style="float: right;width: 80%;width: 57%;height: 29px;padding: 4px;" class="form-control" type="text" name="order_id" id="order_id" placeholder="Purchase Order/ Referance ID" />
                          </td>
                      </tr>
                      </table>
		...
		<table class="table table-bordered" id="print_table" border="1">
          <thead>
                <tr>
                          ...
                          <td class="text-left" style="width: 11.11%;">Current Ware House Inventory</td>
          ...
          <tbody id="t_body">
              ...
              <input type="hidden" name="store_id" id="store_id" value="<?php echo $order_information['products'][0]['store_id']; ?>" />
			  <input type="hidden" name="store_owner_email" id="store_owner_email" value="" />
			  <input type="hidden" name="store_owner_phone" id="store_owner_phone" value="" />
		  <?php
			$grand_total = 0;$a=1;
            ...
            <tr id="tr_<?php echo  $a; ?>">
                ...
                <td class="text-left" id="td_sid_<?php echo  $a; ?>"><?php echo  $a;?></td>
                          <td class="text-left" id="td_p_name_<?php echo  $a; ?>">
                               <?php if(empty($created_po)){ ?> 
                              <input disabled="disabled" required="required" class="form-control" name="product_name[]" id="p_name_<?php echo  $a; ?>" type="text" value="<?php echo  $product['product_name'];?>" />
                               <?php }else{ ?>
		...
		<?php } ?>
			  ...
			  <td id="td_p_hsn_<?php echo  $a; ?>" class="text-left">
                          ...
                          <td class="text-left" id="td_p_inventory_<?php echo  $a; ?>">
		...
		<?php } ?>
			  ...
			  <?php //+$product['product_tax_rate']
                          ...
                          <td>
                          <button  style="display:inline-block;" type="button" id="add_btn_1" class="btn btn-primary add_btn" onclick="return add_row(1);">
                                <i class="fa fa-plus"></i>
                            </button>
                            <button  style="display:inline-block;" type="button" id="remove_btn_1" class="btn btn-danger remove_btn" onclick="return remove_row(1);">
		...
		?>
         ...
         <?php if(empty($created_po)){ ?>
            <input type="button" onclick="return check_ware_house_quantity();" class="btn btn-primary pull-right" id="cr_btn" value="Create Invoice" />
...
function get_ship_to_data(store_id)
{
   if((store_id!="") && (store_id!="0"))
    {
        $.ajax({
            url: 'index.php?route=invoice/purchase_order/get_to_store_data_b2b&token=<?php echo $token; ?>&store_id=' +  encodeURIComponent(store_id),
