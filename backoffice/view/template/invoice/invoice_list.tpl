...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <h1><?php echo "Partner Invoice"; ?></h1>
      <ul class="breadcrumb">
				...
				?>
						<tr>
							...
							<td class="text-left">
                                                            ...
                                                            <a href="<?php echo $invoice . '&invoice_id='.$order['sid']; ?>" data-toggle="tooltip" title="<?php echo "Create/View Invoice"; ?>" style="margin-left: 5px;" class="btn btn-info">
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=invoice/purchase_order&token=<?php echo $token; ?>';
