...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <h1>Expense Waiver off</h1>
      <ul class="breadcrumb">
        <?php foreach ($breadcrumbs as $breadcrumb) { ?>
        <li><a href="<?php echo $breadcrumb['href']; ?>">Expense Waiver off</a></li>
        <?php } ?>
      </ul>
    </div>
  </div>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><a href="index.php?route=setting/debitstore/exp&token=<?php echo $token; ?>&store_id=<?php echo $store['store_id']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
