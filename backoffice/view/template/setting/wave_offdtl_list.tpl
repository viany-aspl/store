  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-list"></i>Expense Report</h3>
	...
	<td class="text-left"><?php echo $pay['store_user']; ?></td>
                  ...
                  <td class="text-right"><?php echo $pay['from_date']; ?></td>
                <td class="text-right"><?php echo $pay['to_date']; ?></td>
                <td class="text-right"><?php echo $pay['response']; ?></td>
               
                  <td class="text-right"><?php echo $pay['cr_date']; ?></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Create Expense waiver</h4>
        </div>
        <div class="modal-body">
        <form action="index.php?route=setting/debitstore/exp&token=<?php echo $token; ?>" method="get" enctype="multipart/form-data" >
...
//alert(store_id);
//return false;
url = 'index.php?route=setting/debitstore/exp&token=<?php echo $token; ?>';
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=setting/debitstore/getWaveoffdata&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=setting/debitstore/getWaveoffdata_download&token=<?php echo $token; ?>';
