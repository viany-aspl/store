...
<div id="content">
  ...
  <div class="container-fluid">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-store" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-tin" data-toggle="tab">TIN-CIN-GSTN</a></li>
          </ul>
	...
	<div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="creditlimit" value="<?php echo $creditlimit; ?>" placeholder="Credit Limit" id="input-creditlimit" class="form-control" />
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-creditlimit">Current Credit</label>
                <div class="col-sm-10">
                  <input type="text" name="currentcredit" value="<?php echo $currentcredit; ?>" placeholder="Current Credit" id="input-creditlimit" class="form-control" readonly />
                  <?php if ($error_creditlimit) { ?>
                  <div class="text-danger"><?php echo $error_creditlimit; ?></div>
                  <?php } ?>
                </div>
