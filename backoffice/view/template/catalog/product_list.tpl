              ...
              <div class="form-group">
                ...
                <select name="filter_category" id="input-filter_category" class="form-control">
                  ...
                  <?php foreach ($product_categories as $product_category) { ?>
						<option <?php if($filter_category==$product_category['category_id']){ ?> selected="selected" <?php } ?> value="<?php echo $product_category['category_id']; ?>"><?php echo $product_category['name']; ?></option>
                    <?php } ?>
...
<td class="text-left"><?php if ($product['special_tax']) { ?>
                  ...
                  <td class="text-right">
                      <a href="<?php echo $product['edit']; ?>" style="width: 40px;margin-top: 2px;" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                      <a href="<?php echo $product['edit_quantity']; ?>"  style="width: 40px;margin-top: 2px;" data-toggle="tooltip" title="Edit product price" class="btn btn-danger"><i class="fa fa-pencil-square-o"></i></a>
						
						<a href="<?php echo $product['edit_promotion']; ?>"  style="width: 40px;margin-top: 2px;" data-toggle="tooltip" title="Product promotion" class="btn btn-danger">
...
$('#button-filter').on('click', function() {
	...
	var filter_category = $('#input-filter_category').val();
...
$('#button-download').on('click', function() {
	var url = 'index.php?route=catalog/product/download_excel&token=<?php echo $token; ?>';
