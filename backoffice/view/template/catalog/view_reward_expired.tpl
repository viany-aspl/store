...
<div class="page-header">
    <div class="container-fluid">
      ...
      <h1>View Expired Reward Points</h1>
...
<div class="panel panel-default">
   <div class="panel-heading">
    ...
    <div style="min-height: 400px;" class="panel-body"><!-----pos/gui_outwards------->
						...
						<?php //$total2=count($rewards_expired); if($total2>0){ ?>
						<div class="table-responsive">
                     
                        <table  id="myTable2"  class=" table table-bordered mb-0 order-list2 text-center ">
                            <thead>
                                <tr style="width:100%">
                            ...
                            <tbody>
                           <?php $a2=0; foreach($rewards_expired as $reward){ ?>
                                <tr>
                               <td> 
                                   <select  disabled required class="js-example-basic-multiple" multiple="multiple" id="store_id2<?php echo $a2; ?>" name="store_id2[<?php echo $a; ?>][]">
                                ...
                                <input required  disabled type="text"  name="product_name2[]" value="<?php echo $reward['product_name']; ?>" id="product_name2<?php echo $a2; ?>" placeholder="Product"  class="form-control product_name" />
                                <input required  disabled type="hidden"  name="product_id2[]" value="<?php echo $reward['product_id']; ?>" id="product_id2<?php echo $a2; ?>" placeholder="Product"  class="form-control product_id" />
                                </td>
                                <td>
										<span id="product_sku_span2<?php echo $a2; ?>"><?php echo $reward['product_sku']; ?></span>
										<input  disabled required  type="hidden"  name="product_sku2[]" value="<?php echo $reward['product_sku']; ?>" id="product_sku2<?php echo $a2; ?>"   class="form-control product_id" />
									</td>
                                 
                                  <td><input  disabled required style="min-width: 70px;" type="text" name="valid_till2[]" value="<?php echo date('m/d/Y',$reward['valid_till']->sec); ?>" id="valid_till2<?php echo $a2; ?>" placeholder="Valid Till"  class="form-control date" /></td>
                                   
                                    <td><input  disabled required  type="text" onkeypress="return isNumber(event)" name="reward_points2[]" value="<?php echo $reward['points']; ?>" id="reward_points2<?php echo $a2; ?>" placeholder="Reward Points"  class="form-control" /></td>
                                    <!--<td> <?php 
                                    if($a==0){ ?> 
                                    ...
                                    <a href="index.php?route=catalog/reward/delete&type=expired&token=<?php echo $token; ?>&product_id=<?php echo $reward['product_id']; ?>&points=<?php echo $reward['points']; ?>&store=<?php echo json_encode($reward['store_id']); ?>" onclick="return confirm('Are you sure ?');" class="btn btn-md btn-danger <?php echo $a; ?>">Delete</a>
