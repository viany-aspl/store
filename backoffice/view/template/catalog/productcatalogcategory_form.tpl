            ...
            <div class="tab-pane active in" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
				  ...
				  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-meta-title<?php echo $language['language_id']; ?>">Child URL</label>
                    <div class="col-sm-10">
                      <input type="text" name="category_description[<?php echo $language['language_id']; ?>][child_url]" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['child_url'] : ''; ?>" placeholder="Child URL" id="input-meta-title<?php echo $language['language_id']; ?>" class="form-control" />
                      <?php if (isset($error_child_url[$language['language_id']])) { ?>
                      <div class="text-danger"><?php echo $error_child_url[$language['language_id']]; ?></div>
                      <?php } ?>
                    </div>
                  </div>
                  <div class="form-group">
            ...
            <div class="tab-pane fade" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
				  ...
				  <a style="cursor: pointer;" onclick="$(this).parent().find(':checkbox').prop('checked', true);">Select All</a> / <a style="cursor: pointer;" onclick="$(this).parent().find(':checkbox').prop('checked', false);">Un-Select All</a>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-top"><span data-toggle="tooltip" title="<?php echo $help_top; ?>">Show on Dashboard</span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($top) { ?>
...
$('input[name=\'path\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/dashboardcategory/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
