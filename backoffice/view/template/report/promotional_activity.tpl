...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <h1><?php  echo 'Promotional Activity';//$heading_title; ?></h1>
      <ul class="breadcrumb">
  ...
  <div class="container-fluid">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-bar-chart"></i> <?php echo 'Promotional Activity';//$text_list; ?></h3>
        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <div class="form-group">
                <label class="control-label" for="input-name">Select Activity</label>
	...
	<span style="font-weight: bold;">
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <?php if ($activities) { ?>
              <?php foreach ($activities as $activity) { //print_r($activity);
					
					
		//echo $price_without_tax;
			  ?>
              <tr>
                <td class="text-left"><?php echo $activity['auto_activity_id']; ?></td>
                <td class="text-left"><?php echo $activity['activity_name']; ?></td>
                <td class="text-left"><?php echo $activity['dats']; ?></td>
                <td class="text-left"><?php echo $activity['representative_name']; ?></td>
                
                <td class="text-left"><?php echo $activity['representative_mobile']; ?></td>
                <td class="text-left"><?php echo $activity['company_name']; ?></td>
				 <td class="text-left"><?php echo $activity['store_name']; ?></td>
				 <td class="text-left"><a type="button" onclick="return set_image('<?php echo $activity['auto_activity_id']; ?>','<?php echo $activity['images']; ?>');" class="btn btn-info btn-lg" value="<?php echo $activity['auto_activity_id']; ?>" data-toggle="modal" data-target="#myModal">Images</a></td>
  ...
  <div class="modal-dialog  modal-xl">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<input type="hidden" name="auto_activity_id"   value="" id="auto_activity_id" class="form-control" />
        <h4 class="modal-title">Images</h4>
      </div>
      <div class="modal-body">
	  <div class="row">
		  <div class="col-md-6">
		  <center><h4 class="modal-title" id="text1">Image 1</h4></center>
		   <img style="margin-bottom:25px; src="#" id="img1" height="250px" width="250px">
		   
		   </div>
		   <div class="col-md-6">
		   <center><h4 class="modal-title" id="text2">Image 2</h4></center>
			<img src="#" id="img2" height="250px" width="250px">
			</div>
		</div>
		
		<div class="row">
			<div class="col-md-6" ">
			<center> <h4 class="modal-title" id="text3">Image 3</h4> </center>
			 <img style="margin-bottom:25px;" src="#" id="img3" height="250px" width="250px">
			 </div>
			 <div class="col-md-6">
			 <center><h4 class="modal-title" id="text4">Image 4</h4></center>
			  <img src="#" id="img4" height="250px" width="250px">
			  </div>
		  </div>
      </div>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/promotional_activity&token=<?php echo $token; ?>';
	...
	var filter_name = $('#input-name').val();//$('input[name=\'filter_activity_name\']').val();
	if (filter_name) {
...
$('#button-download').on('click', function() {
    url = 'index.php?route=report/promotional_activity/download_excel&token=<?php echo $token; ?>';
