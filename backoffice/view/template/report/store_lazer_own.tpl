  ...
  <div class="container-fluid">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-bar-chart"></i>Store Ledger Report</h3>
	 <button type="button" id="button-download" class="btn btn-primary pull-right" <?php if($filter_stores_id=="") { ?>style="margin-top: -8px;display: none;" <?php } else { ?> style="margin-top: -8px;"  <?php } ?>> Download</button>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <select name="filter_stores_id" style="width:100%;" id="input-store" class="select2 form-control" onchange="return show_download(this.value);">
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <td class="text-right">INVOICE / TRANSACTION NO.</td>
                <td class="text-right"> DEPOSIT / CREDIT NOTE / WAIVER / SALE / MATERIAL RECEIVED  (CR) </td>
                <td class="text-right">INVOICE AMOUNT (DB)</td>
                <td class="text-right">CREDIT STATUS</td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/leadger&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=report/leadger/download_pdf&token=<?php echo $token; ?>';
