  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" <?php if($group=="11") { echo "style='display:none;'"; } ?> data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-affiliate').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php if ($affiliate['approve']) { ; ?>
                    <a <?php if($group!="1") { echo "style='display:none;'"; } ?> href="<?php echo $affiliate['approve']; ?>" data-toggle="tooltip" title="<?php echo $button_approve; ?>" class="btn btn-success"><i class="fa fa-thumbs-o-up"></i></a>
                    <?php } else { ?>
                    <button <?php if($group!="1") { echo "style='display:none;'"; } ?> type="button" class="btn btn-success" disabled><i class="fa fa-thumbs-o-up"></i></button>
                    <?php } ?>
                    <?php if ($affiliate['unlock']) { ; ?>
                    <a <?php if($group!="1") { echo "style='display:none;'"; } ?> href="<?php echo $affiliate['unlock']; ?>" data-toggle="tooltip" title="<?php echo $button_unlock; ?>" class="btn btn-warning"><i class="fa fa-unlock"></i></a>
                    <?php } else { ?>
                    <button <?php if($group!="1") { echo "style='display:none;'"; } ?> type="button" class="btn btn-warning" disabled><i class="fa fa-unlock"></i></button>
                    <?php } ?>                   
