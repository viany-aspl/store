  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
		...
		<li><a href="#tab-crop" data-toggle="tab"><?php echo $tab_crop; ?></a></li>
...
<div class="form-group required">
                <label class="col-sm-2 control-label" for="input-kharif"><?php  echo $entry_kharif." 1"; ?></label>
                <div class="col-sm-4">
                  <select name="kharif_id1" id="input-kharif" class="form-control">
                    <option value=""><?php echo $text_select; ?></option>
                    <?php  foreach ($crops as $kharif) { ?>
                    <?php if ($kharif['id'] == $kharif_id1) { ?>
                    <option value="<?php echo $kharif['id']; ?>" selected="selected"> <?php echo $kharif['name']; ?> </option>
                    <?php } else { ?>
                    <option value="<?php echo $kharif['id']; ?>"><?php echo $kharif['name']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                  <?php if ($error_kharif) { ?>
                  <div class="text-danger"><?php echo $error_kharif; ?></div>
                  <?php } ?>
                </div>
<div class="col-sm-4">
<input type="text" name="kharif_acre1" value="<?php echo $kharif_acre1; ?>" placeholder="<?php echo $entry_kharif_acre; ?>" id="input-kharif-acre1" class="form-control" />

</div>
              </div>

<div class="form-group required">
                <label class="col-sm-2 control-label" for="input-kharif"><?php echo $entry_kharif." 2"; ?></label>
                <div class="col-sm-4">
                  <select name="kharif_id2" id="input-kharif" class="form-control">
                    <option value=""><?php echo $text_select; ?></option>
                    <?php foreach ($crops as $kharif) { ?>
                    <?php if ($kharif['id'] == $kharif_id2) { ?>
                    <option value="<?php echo $kharif['id']; ?>" selected="selected"> <?php echo $kharif['name']; ?> </option>
                    <?php } else { ?>
                    <option value="<?php echo $kharif['id']; ?>"><?php echo $kharif['name']; ?></option>
                    <?php } ?>
...
<div class="col-sm-4">
<input type="text" name="kharif_acre2" value="<?php echo $kharif_acre2; ?>" placeholder="<?php echo $entry_kharif_acre; ?>" id="input-kharif-acre2" class="form-control" />
...
<div class="form-group required">
                <label class="col-sm-2 control-label" for="input-rabi"><?php echo $entry_rabi." 1"; ?></label>
                <div class="col-sm-4">
                  <select name="rabi_id1" id="input-Rabi" class="form-control">
                    <option value=""><?php echo $text_select; ?></option>
                    <?php foreach ($crops as $kharif) { ?>
                    <?php if ($kharif['id'] == $rabi_id1) { ?>
                    <option value="<?php echo $kharif['id']; ?>" selected="selected"> <?php echo $kharif['name']; ?> </option>
                    <?php } else { ?>
                    <option value="<?php echo $kharif['id']; ?>"><?php echo $kharif['name']; ?></option>
                    <?php } ?>
...
<div class="col-sm-4">
<input type="text" name="rabi_acre1" value="<?php echo $rabi_acre1; ?>" placeholder="<?php echo $entry_rabi_acre; ?>" id="input-rabi-acre1" class="form-control" />
...
<div class="form-group required">
                <label class="col-sm-2 control-label" for="input-rabi"><?php echo $entry_rabi." 2"; ?></label>
                <div class="col-sm-4">
                  <select name="rabi_id2" id="input-kharif" class="form-control">
                    <option value=""><?php echo $text_select; ?></option>
                    <?php foreach ($crops as $rabi) { ?>
                    <?php if ($rabi['id'] == $rabi_id2) { ?>
                    <option value="<?php echo $rabi['id']; ?>" selected="selected"> <?php echo $rabi['name']; ?> </option>
                    <?php } else { ?>
                    <option value="<?php echo $rabi['id']; ?>"><?php echo $rabi['name']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                  <?php if ($error_rabi) { ?>
                  <div class="text-danger"><?php echo $error_rabi; ?></div>
                  <?php } ?>
                </div>
<div class="col-sm-4">
<input type="text" name="rabi_acre2" value="<?php echo $rabi_acre2; ?>" placeholder="<?php echo $entry_rabi_acre; ?>" id="input-rabi-acre2" class="form-control" />
