...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div <?php if($group!="1") { echo "style='display:none;'"; } ?>  class="row">
      ...
      <div class="row">
          <?php   $msChart = new FusionCharts("mscombidy2d", "", "100%", "400", "chart-container", "json", $comparasion_chart);
    ...
    <div class="row">
      ...
      <div <?php  if($group!="1") { echo "style='display:none;'"; } ?>  class="col-lg-6 col-md-12 col-sm-12 col-sx-12">
          <?php echo $activity; ?>
      </div>
