  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo "Add Stock Order (<span style='color:red'>*</span>) shows field is required"; ?></h3>
      </div>
...
function loadRelatedOptionValues(evnt)
{
	$(document).ready(function()
    {
		...
		$.ajax({
		url: 'index.php?route=stock/purchase_order/getRelatedOptionValues&token=<?php echo $token; ?>&option_id=' + option_id,
		type: 'post',
		dataType: 'json',
