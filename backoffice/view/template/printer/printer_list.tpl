            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <?php foreach ($printers as $printer) {
                     ...
                     ?>
                <tr>
                  <td class="text-center"><?php if (in_array($printer['printer_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $printer['printer_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $printer['printer_id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $printer['name']; ?></td>
                  <td class="text-left"><?php echo $printer['model']; ?></td>
                  <td class="text-right"><a href="<?php echo $printer['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
