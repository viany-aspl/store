  ...
  <?php foreach ($orders as $order) {
    //print_r($order);
      ...
      <table style="width: 94%;">
        <tr>
            <td style="width: 50%;"><h1><?php  echo $text_invoice; ?> #<?php echo $order['invoice_no']; ?></h1></td> 
            <td style="width: 50%;text-align: right;">
                <div style="border: 1px solid silver;width: 120px;float: right;height: 120px;margin-bottom: 5px;margin-top: 5px;">
                    <?php  if($order['profile_pic']!="") { ?>
                       <img style="width: 120px;height: 120px;margin-bottom: 5px;" src="<?php echo HTTPS_CATALOG; ?>/system/upload/<?php echo $order['profile_pic']; ?>" />
                   <?php } ?>
                </div>
...
<td style="width: 50%;">
	<b>Father Name : </b> <?php echo $order['father_name']; ?>
...
<tr>
<td style="width: 50%;">
 <b>Grower ID : </b> <?php echo $order['grower_id']; ?>
</td>
<td style="width: 50%;">
...
<tr>
<td style="width: 50%;">
 	<b>Farmer Name : </b> <?php echo $order['farmer_name']; ?>
</td>
<td style="width: 50%;">
...
<tr>
<td style="width: 50%;">
  <b>Village Name : </b> <?php echo $order['village_name']; ?>
</td>
<td style="width: 50%;">
...
<tr>
          <td style="width: 50%;"><address>
            ...
            <b>Grower ID : </b> <?php echo $order['grower_id']; ?><br /><br />
            
            <b>Farmer Name : </b> <?php echo $order['farmer_name']; ?><br /><br />
            <b>Village Name : </b> <?php echo $order['village_name']; ?></td>
          
            <td style="width: 50%;">
                <b>Father's Name  : </b> <?php echo $order['father_name']; ?><br /><br />
...
<table class="table table-bordered" style="width: 94%;">
    ...
    <table class="table table-bordered" style="width: 94%;">
      ...
      <tbody>
        <tr>
          <td><address>
            <?php echo $order['bank_id_number']; ?>
            </address></td>
          <td><address>
                    	<?php echo $order['identity_type']; ?>
            </address></td>
             <td><address>
            <?php echo $order['identity_number']; ?>
            </address></td>
        </tr>
      </tbody>
    </table>
