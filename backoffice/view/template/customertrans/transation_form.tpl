...
<ul id="geo" class="nav nav-tabs nav-justified">
            <li class="<?php echo $tab1; ?>"><a onclick="return active_tab(1); " href="#tab-nation" data-toggle="tab">Customer Reward</a></li>
            <li class="<?php echo $tab2; ?>"><a onclick="return active_tab(2); " href="#tab-zone" data-toggle="tab">Customer Store</a></li>
            <li class="<?php echo $tab3; ?>"><a onclick="return active_tab(3); " href="#tab-region" data-toggle="tab">Customer Store To Trans</a></li>
            <li class="<?php echo $tab4; ?>"><a onclick="return active_tab(4); " href="#tab-state" data-toggle="tab">Product Reward</a></li>
     ...
     <div class="tab-pane <?php echo $tab1; ?>" id="tab-nation">
      <div class="panel-body">
        ...
        <div class="panel-body">
	     ...
	     ?>
              <tr>
                <td class="text-left"><?php echo $customer['store_name']; ?></td>
                <td class="text-left"><?php echo $customer['store_id']; ?></td>
                <td class="text-left"><?php echo $customer['customer_id']; ?></td>
                <td class="text-left"><?php echo $customer['inv_no']; ?></td>
...
<!--*****************************************Sale*****************************************-->  
 ...
 <div class="tab-pane <?php echo $tab3; ?>" id="tab-region">
	...
	<td class="text-left">Cash</td>
          	<td class="text-left">Trans TYpe</td>
            ...
            <tbody>
              ...
              <?php if($customers3) { 
                  foreach ($customers3 as $customer3) { //print_r($order); ?>
              <tr>
               <td class="text-left"><?php echo  $customer3['store_id'];; ?></td>
                
              <td class="text-left"><?php echo $customer3['customer_id']; ?></td>
             
              <td class="text-left"><?php echo $customer3['credit']; ?></td>
              <td class="text-left"><?php echo $customer3['cash']; ?></td> 
	<td class="text-left"><?php echo $customer3['trans_type']; ?></td>
	<td class="text-left"><?php echo $customer3['create_time']; ?></td>
    ...
    <div class="panel-body">
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
              <td class="text-left">Store Id</td>
                <td class="text-left">Old Points</td>
                
                 <td class="text-left">Product Name</td>
	   <td class="text-left">Product Id</td>
                <td class="text-left">Valid Till</td> 
	        <td class="text-left">Start Date</td>
	        <td class="text-left">Update Date</td>
                <td class="text-left">Points</td>
	
              </tr>
            </thead>
            <tbody>
              <?php if ($customers4) { $total3=0; ?>
              <?php foreach ($customers4 as $customer) { ?>
              <tr>
                <td class="text-left"><?php echo $customer['store_id']; ?></td>
                <td class="text-left"><?php echo $customer['old_points']; ?></td>
                <td class="text-left"><?php echo $customer['product_name']; ?></td>
                <td class="text-left"><?php echo $customer['product_id']; ?></td>
                <td class="text-left"><?php echo $customer['valid_till']; ?></td>
                <td class="text-left"><?php echo $customer['start_date']; ?></td>
	      
	        <td class="text-left"><?php echo $customer['update_date']; ?></td>
    ...
    <div class="panel-body">
        ...
        <div class="panel-body">
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                <td class="text-left">Store Id</td>
                <td class="text-right">Old Points</td>
                <!--<td class="text-right">Store id</td>
                <td class="text-right">Store Credit Limit</td>
	  <td class="text-right">Current Credit</td>-->
	   ...
	   <td class="text-right">Product Id</td>
	        ...
	        <td class="text-right">update Date</td>
...
$('#button-filter').on('click', function() {
	 url = 'index.php?route=customertrans/transation&token=<?php echo $token; ?>';
	 //url += '&page='+'1';
         //url += '&tab='+'1';
...
<script type="text/javascript">
	...
	url = 'index.php?route=customertrans/transation/download_excel_customerrewards&token=<?php echo $token; ?>';
...
$('#button-download2').on('click', function() {
	url = 'index.php?route=customertrans/transation/download_customer_to_store&token=<?php echo $token; ?>';
...
$('#button-download3').on('click', function() {
    url = 'index.php?route=customertrans/transation/download_customer_to_trans&token=<?php echo $token; ?>';
    	var filter_date_start = $('input[name=\'filter_date_start\']').val();
   ...
   $('#button-download4').on('click', function() {
    url = 'index.php?route=customertrans/transation/download_product_rewards&token=<?php echo $token; ?>';
 ...
 $('#button-download5').on('click', function() {
    url = 'index.php?route=reportbcml/product_storewisesales/download_excel&token=<?php echo $token; ?>';
  ...
  $('#button-download6').on('click', function() {
    url = 'index.php?route=reportbcml/inventory_report/download_excel&token=<?php echo $token; ?>';
...
$('#button-download7').on('click', function() {
    url = 'index.php?route=reportbcml/sale_summary/download_excel_category_date_wise&token=<?php echo $token; ?>';
    	var filter_date_start = $('input[name=\'filter_date_start\']').val();
...
$('#button-download8').on('click', function() {
    url = 'index.php?route=reportbcml/expenseapprove/getlist_download&token=<?php echo $token; ?>';
    	var filter_date_start = $('input[name=\'filter_date_start\']').val();
