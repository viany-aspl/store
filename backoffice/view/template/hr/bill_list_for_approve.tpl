      ...
      <div class="panel-body">
	    ...
	    <td class="text-left">Submit by</td>
	     ...
	     <td class="text-left">Month/Year</td>
                  ...
                  <td class="text-left" style="max-width: 150px;">Remarks</td>
	    ...
	    <td class="text-left"><?php echo $bill['submitby']; ?></td>
                  ...
                  <td class="text-left"><div style="max-width: 150px;word-wrap: break-word;"><?php echo $bill['remarks']; ?></div></td>
		...
		<a onclick="return confirm('Are you sure you want to approve this bill ?');" class="btn btn-primary pull-right"  style="background-color: #9DD432;width: 71px;" href="index.php?route=hr/expenseapprove/accept&token=<?php echo $token; ?>&bill_id=<?php echo $bill["tr_id"]; ?>">Approve  </a>
<br/>
  ...
  <div class="modal fade" id="myModal_partner" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form action="index.php?route=hr/expenseapprove/reject&token=<?php echo $token; ?>" method="post" enctype="multipart/form-data">
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=hr/expenseapprove&token=<?php echo $token; ?>';
