  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-list"></i>Tagged Function List</h3>
      </div>
        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-store">
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                <?php if ($tagged) { $a=1; ?>
                <?php foreach ($tagged as $un) { ?>
                <tr>
                  <td class="text-left"><?php echo $a; ?></td>
	    <td class="text-left"><?php echo $un['functypeid']; ?></td>
                  <td class="text-left"><?php echo $un['companyid']; ?></td>
                   <td class="text-left"><?php echo $un['funname']; ?></td>
