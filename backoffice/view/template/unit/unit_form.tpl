  ...
  <div class="page-header">
    <div class="container-fluid">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="<?php echo $breadcrumb['href']; ?>">Unit Update</a></li>
        <?php } ?>
      </ul>
    </div>
  </div>
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i>Update Unit </h3>
      </div>
	...
	<div class="form-group required">
            ...
            <div class="form-group required">
                ...
                <div class="col-sm-10">
                    <input type="text" name="unit_name" value="<?php echo $unit_values[0]['unit_name']; ?>"  id="unit_name" class="form-control"  required="required" />
                    <input type="hidden" name="id" value="<?php echo $unit_values[0]['sid']; ?>"  id="id" class="form-control"/>
                  <?php if ($error_meta_title) { ?>
                  <div class="text-danger"><?php echo $error_meta_title; ?></div>
                  <?php } ?>
                </div>
	...
	<div class="form-group required">
                ...
                <div class="col-sm-10">
                    <input type="text" name="unit_id" value="<?php echo $unit_values[0]['unit_id']; ?>"  id="unit_id" class="form-control"  required="required" />
                  <?php if ($error_meta_title) { ?>
                  <div class="text-danger"><?php echo $error_meta_title; ?></div>
                  <?php } ?>
                </div>
