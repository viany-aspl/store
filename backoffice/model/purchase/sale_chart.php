<?php
class ModelPurchaseSaleChart extends Model {
	...
	public function getChartFilterData($data)
	{
		...
		".DB_PREFIX."order
		INNER JOIN ".DB_PREFIX."order_product 
			ON (".DB_PREFIX."order.order_id = ".DB_PREFIX."order_product.order_id) WHERE ".DB_PREFIX."order.date_added BETWEEN '".$data['date_start']." 00:00:00.00' AND '".$data['date_end']." 23:59:59.999' AND ".DB_PREFIX."order.date_modified BETWEEN '".$data['date_start']." 00:00:00.00' AND '".$data['date_end']." 23:59:59.999'");
