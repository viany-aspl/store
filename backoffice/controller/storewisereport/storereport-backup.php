...
/*********************************  end  Material received ****************************************/ 
 ...
 /*****************************************SALE**********************************************/               
		   ...
		   $results3 = $this->model_report_sale_summary->getSale_summary_category($filter_data3);
                   ...
                   //print_r($results);die;
                	$data['total_cash_all']=$t3["Cash"];
                        $data['total_tagged_all']=$t3["Tagged"];
                        $data['total_subsidy_all']=$t3["Subsidy"];
		        $data['total_cash_tagged_all']=$t3["Cash_Tagged"];
                        //print_r($results3);
		foreach ($results3 as $result) {  
                    
			$data['total_cash']=$total_cash+$result['Cash'];
                        $data['total_tagged']=$total_tagged+$result['Tagged'];
                        $data['total_subsidy']=$total_subsidy+$result['Subsidy'];
			$data['total_Cash_Tagged']=$total_Cash_Tagged+$result['Cash_Tagged'];
...
$this->load->model('setting/store');       
      ...
      //if($this->request->get['tab']=="1"){
		...
		$pagination6->total = $order_total6;
