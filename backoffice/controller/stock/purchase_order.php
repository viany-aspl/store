...
class ControllerstockPurchaseOrder extends Controller{
	...
	public function index()
	{
		...
		$data['breadcrumbs'][] = array(
			'text' => 'Stock Request',
			'href' => $this->url->link('stock/purchase_order', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$order_total = $this->model_stock_purchase_order->getTotalOrders($filter_data);
		...
		//$results = $this->model_sale_order->getOrders($filter_data);
                $data['order_list'] = $this->model_stock_purchase_order->getList($filter_data);
		...
		$pagination->url = $this->url->link('stock/purchase_order', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
