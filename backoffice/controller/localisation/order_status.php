	...
	protected function getList() {
		...
		$filter_data = array(
			...
			'limit' => $this->config->get('config_limit_admin')
                ...
                $return_data=$this->model_localisation_order_status->getOrderStatuses($filter_data);
		$order_status_total = $return_data->num_rows;//$this->model_localisation_order_status->getTotalOrderStatuses();

		$results = $return_data->rows;
