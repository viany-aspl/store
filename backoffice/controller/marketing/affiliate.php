...
class ControllerMarketingAffiliate extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_kharif']	=	"Kharif Crop";
		$data['entry_rabi']	=	"Rabi Crop";
		$data['entry_kharif_acre']="Kharif Acre";
		$data['entry_rabi_acre']="Rabi Acre";
		...
		$data['tab_crop'] = $this->language->get('tab_crop');	
		...
		$data['crops'] =$this->model_marketing_affiliate->getCrops();
		...
		//Rabi crop 
                ...
                if (isset($this->request->post['rabi_id1'])) {
			$data['rabi_id1'] = $this->request->post['rabi_id1'];
		} elseif (!empty($affiliate_info)) {
			$data['rabi_id1'] = $affiliate_info['rabi_crop_1'];
		} else {
			$data['rabi_id1'] = '';
		}


if (isset($this->request->post['rabi_id2'])) {
			$data['rabi_id2'] = $this->request->post['rabi_id2'];
		} elseif (!empty($affiliate_info)) {
			$data['rabi_id2'] = $affiliate_info['rabi_crop_2'];
		} else {
			$data['rabi_id2'] = '';
		}
		...
		//rabi acre 
if (isset($this->request->post['rabi_acre1'])) {
			$data['rabi_acre1'] = $this->request->post['rabi_acre1'];
		} elseif (!empty($affiliate_info)) {
			$data['rabi_acre1'] = $affiliate_info['rabi_crop_1_acre'];
		} else {
			$data['rabi_acre1'] = '';
		}

if (isset($this->request->post['rabi_acre2'])) {
			$data['rabi_acre2'] = $this->request->post['rabi_acre2'];
		} elseif (!empty($affiliate_info)) {
			$data['rabi_acre2'] = $affiliate_info['rabi_crop_2_acre'];
		} else {
			$data['rabi_acre2'] = '';
		}	
		...
		//kharif
                ...
                if (isset($this->request->post['kharif_id1'])) {
			$data['kharif_id1'] = $this->request->post['kharif_id1'];
		} elseif (!empty($affiliate_info)) {
			$data['kharif_id1'] = $affiliate_info['kharif_crop_1'];
		} else {
			$data['kharif_id1'] = '';
		}


if (isset($this->request->post['kharif_id2'])) {
			$data['kharif_id2'] = $this->request->post['kharif_id2'];
		} elseif (!empty($affiliate_info)) {
			$data['kharif_id2'] = $affiliate_info['kharif_crop_2'];
		} else {
			$data['kharif_id2'] = '';
		}
...
if (isset($this->request->post['kharif_acre1'])) {
			$data['kharif_acre1'] = $this->request->post['kharif_acre1'];
		} elseif (!empty($affiliate_info)) {
			$data['kharif_acre1'] = $affiliate_info['kharif_crop_1_acre'];
		} else {
			$data['kharif_acre1'] = '';
		}

if (isset($this->request->post['kharif_acre2'])) {
			$data['kharif_acre2'] = $this->request->post['kharif_acre2'];
		} elseif (!empty($affiliate_info)) {
			$data['kharif_acre2'] = $affiliate_info['kharif_crop_2_acre'];
		} else {
			$data['kharif_acre2'] = '';
		}	
			...
			$data['user_store_id'] = $affiliate_info['store_id'];
		} else {
			$data['user_store_id'] = '';
		}
                //store addition end
...
$data['user_stores'] = $this->model_setting_store->getStoreInv($this->user->getStoreId());                
		...
		if (isset($this->request->post['code'])) {
			...
			$data['code'] = $affiliate_info['code'];
				...
				$digit=strtoupper(hexdec(bin2hex(openssl_random_pseudo_bytes(2))));					
				if(strlen($digit) < 6)
					{
						if(strlen($digit)>4){$digit=$digit.rand(0,10);}
						if(strlen($digit)==4){$digit=$digit.rand(10,100);}
						if(strlen($digit)<4){$digit=$digit.rand(100,1000);}
					}
			$data['code'] =$digit; //uniqid();
		}
