<?php
class ControllerCatalogImgmarque extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('catalog/imgmarque');

		$this->document->setTitle($this->language->get('heading_title'));

		$this->load->model('catalog/imgmarque');
	...
	public function add() 
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) 
		{
			...
			$this->model_catalog_imgmarque->addFaq($this->request->post);
			...
			$this->response->redirect($this->url->link('catalog/imgmarque', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	public function edit() 
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) 
		{
			$this->model_catalog_imgmarque->editFaq($this->request->get['faq_id'], $this->request->post);
    ...
    public function delete() 
	{
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) 
		{
			...
			{
				$this->model_catalog_imgmarque->deleteFaq($id);
			}
	...
	protected function getList() 
	{
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/imgmarque', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['add'] = $this->url->link('catalog/imgmarque/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('catalog/imgmarque/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) 
		{
			...
			$data['faqs'][] = array(
				...
				'edit'       => $this->url->link('catalog/imgmarque/edit', 'token=' . $this->session->data['token'] . '&faq_id=' . $result['faq_id'] . $url, true)
			);
		}
		...
		$pagination->url = $this->url->link('catalog/imgmarque', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('catalog/imgmarque_list.tpl', $data));
	}
	...
	protected function getForm() 
	{
		...
		if (!isset($this->request->get['faq_id'])) {
			$data['action'] = $this->url->link('catalog/imgmarque/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/imgmarque/edit', 'token=' . $this->session->data['token'] . '&faq_id=' . $this->request->get['faq_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('catalog/imgmarque', 'token=' . $this->session->data['token'] . $url, true);

		if (isset($this->request->get['faq_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) 
		{
			$faq_info = $this->model_catalog_imgmarque->getfaq($this->request->get['faq_id']);
		}
 ...
 if (isset($this->request->post['question'])) {
		...
		$this->response->setOutput($this->load->view('catalog/imgmarque_form.tpl', $data));
	}

	protected function validateForm() {
		
		if (!$this->user->hasPermission('modify', 'catalog/imgmarque')) {
