...
class ControllerCatalogManufacturer extends Controller {
	...
	protected function getList() 
	{
		...
		$ret_data = $this->model_catalog_manufacturer->getManufacturers($filter_data);

		$results =$ret_data ->rows ;
		$manufacturer_total=$ret_data ->num_rows;
	...
	public function autocomplete() 
	{
		...
		if (isset($this->request->get['filter_name'])) 
		{
			...
			$results = $this->model_catalog_manufacturer->getManufacturers($filter_data)->rows;
