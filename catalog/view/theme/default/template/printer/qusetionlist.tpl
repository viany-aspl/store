...
<html lang="en">
    ...
    <body data-ma-theme="blue">
		...
		<div class="row" >
			<div class="col-md-12">
			<br/>
				<?php foreach($qusetions as $qusetion){ //print_r($qusetion); ?>
					<div class="card">
                            <a class="listview__item" href="index.php?route=mpos/printer/answer&printer_id=<?php echo $qusetion['printer_id']; ?>&store_id=<?php echo $store_id; ?>">
                           
                                <div class="listview__content col-xs-10">
								
                                    <div class="listview__heading"><b>Product Name : </b> <?php echo $qusetion['name']; ?></div>
                                    <div class="listview__heading"><b>Price : </b> <?php echo $qusetion['price']; ?></div>
										<div class="listview__heading"><b>Manufacturer : </b> <?php echo $qusetion['manufacturer_name']; ?></div>
                                </div>
									<div class="listview__right col-xs-2" style="text-align: right; margin-left:15px;">
										<div class="listview__heading">
											 
												<img src="<?php echo 'system/upload/printer_doc/'.$qusetion['image'][0]; ?>" style="height: 100px;width: 80px;" class="" alt="">
