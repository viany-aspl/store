    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          ...
          <button type="button" class="btn btn-primary btn-lg btn-block" onclick="regQuery('<?php echo $product_id; ?>','<?php echo $heading_title; ?>');"><i class="fa fa-envelope" aria-hidden="true"></i> <span class="hidden-xs hidden-sm hidden-md">&nbsp;&nbsp;&nbsp;<?php echo $button_enquiry; ?></span></button>
