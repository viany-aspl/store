			...
			<div class="col-md-10 col-md-offset-1 ">
				<div class="inner_space1">
					<div class="inner_container">
                     ...
                     <div style="margin-left: 20px;width:80%;" class="alert alert-danger" role="alert">
                                <?php echo $error; ?>
                            </div>
                    <?php } ?>
										<div class="col-md-12">
											...
											<div class="table-responsive" style="overflow-x: inherit !important;min-height: 120px;">
												<form action="index.php?route=mpos/unnatimitra/checkotp" method="post">
                        <div class="col-sm-6">
                                    <div class="input-group">
                                        
                                        <div class="form-group" style="margin-top: 20px;">
                                            <input class="form-control" readonly="readonly" value="<?php echo $mobile; ?>" autocomplete="off" name="mobile" required="required" id="mobile" placeholder="Your Mobile Number" type="text">
                            ...
                            <div class="col-sm-6">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group" style="margin-top: 20px;">
                                            <input class="form-control" onkeypress="return isNumber(event)" maxlength="4" autocomplete="off" name="ttp" required="required" id="ttp" placeholder="OTP" type="text">
                                            <i class="form-group__bar"></i>
                                        </div>
                                    </div>
                            ...
                            <br><br>
                            <a href="index.php?route=mpos/unnatimitra/statement&store_id=<?php echo $store_id; ?>">Resend OTP</a>
                        </div>
                        </form>
											</div>
										</div>
			...
			<div class="row">
				...
				<div class="col-xs-5 col-sm-5 col-md-5">
					<div class="footer_link">
						<ul>
							<li><a href="https://unnatiagro.in/unnatimitra/index.html">Home</a></li>
						</ul>
					</div>
				</div>
			</div>
