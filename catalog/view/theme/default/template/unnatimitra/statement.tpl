			...
			<div class="col-md-10 col-md-offset-1 ">
				<div class="inner_space1">
                    ...
                    <?php } ?>
												...
												<table id="data-table" class="table table-bordered" style="width:100%;">
													...
													<thead>
														...
														<tr>
															...
															<th style="width:25%;background:#1d618e;color:#fff;">Date</th>

															<th style="width:25%;background:#1d618e;color:#fff;">Invoice</th>

															<th style="width:25%;background:#1d618e;color:#fff;">POS</th>

															<th style="width:25%;background:#1d618e;color:#fff;">Earn/Redeem</th>
                                    ...
                                    <tr>
                                        <td><?php echo date('d-m-Y',$order['date_added']->sec); ?></td>
                                        <td><?php echo $order['inv_no']; ?></td>
                                        <td><?php echo $order['store_name']; ?></td>
                                        <td><?php 
                                        if($order['type']=='Add')
                                        {
                                            echo '<font color="green">+'.number_format((float)($order['points']),2,'.','').'</font>';
                                        }
                                        if($order['type']=='Redeem')
                                        {
                                            echo '<font color="red">-'.number_format((float)($order['points']),2,'.','').'</font>';
                                        }
                                        ?></td>
