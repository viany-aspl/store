			...
			<div class="col-md-12 mt-3">
				<div class="card">
                        <div class="card-header">
                            ...
                            <small class="card-subtitle"><?php echo $category['description']; ?></small>
                        </div>
				</div>
				
                  <?php foreach($faqs as $faq){ ?>
					<div class="card">
                            <a class="listview__item" href="index.php?route=mpos/faq/answer&cat_id=<?php echo $category['id']; ?>&faq_id=<?php echo $faq['faq_id']; ?>">
                            <?php if(!empty($faq['image'])){ ?> 
								<img src="image/<?php echo $faq['image']; ?>" class="listview__img" alt="">
								<?php } else { ?>
								<i class='zmdi zmdi-pin-help zmdi-hc-fw'></i>
								<?php } ?>

                                <div class="listview__content">
                                    <div class="listview__heading"><?php echo $faq['faq_description']['1']['question']; ?></div>
