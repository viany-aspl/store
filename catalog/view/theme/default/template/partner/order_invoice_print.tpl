                    ...
                    <tr>
                      ...
                      <tr>
                          ...
                          <td style="width: 50%;" class="col-sm-6">
                              ...
                              Invoice Date: <?php echo $order_information['order_info']['create_date'];  ?><br />
		  ...
		  ?>
            <tr id="tr_<?php echo  $a; ?>">
			  ...
			  <td class="text-left" id="td_p_price_<?php echo  $a; ?>">
                               <?php echo number_format((float)$product['product_price'], 2, '.', '');//round($product['product_price'],PHP_ROUND_HALF_UP);?>
                           </td>
			  ...
			  <?php 
                          echo number_format((float)(($product['product_price'])*$product['product_quantity']), 2, '.', '');
                          $grand_total=$grand_total+(($product['product_price'])*$product['product_quantity']);
                          ?>
		...
		?>
		   ...
		   if(trim($product['product_tax_type'])=="GST@5%"){ 
                ...
                //$gst_5_array[]=array(number_format((float)(((round($product['product_price'],PHP_ROUND_HALF_UP))*$product['product_quantity'])*$cgst/100), 2, '.', ''));
                 ...
                 $total_gst_5=0;$total_gst_12=0;$total_gst_18=0;$total_gst_28=0;
               ...
               foreach($gst_12_array as $gst_12)
                ...
                <?php if(count($gst_5_array)>0){?> 
                  ...
                  <?php } ?>  
					  ...
					  <tr>
                        <?php if(count($gst_28_array)>0){?> 
                        <td colspan="7" style="text-align: right;">
                            <!--<p>-This will be cumulative sum of Tax added on all products for this category</p>
                            <p>-Only that tax will be displayed that is added included in the invoice</p>
                            --><span class="pull-right">CGST @14%  : <?php echo number_format((float)$total_gst_28, 2, '.', ''); ?></span><br />
                            <span class="pull-right">SGST @14% : <?php echo number_format((float)$total_gst_28, 2, '.', ''); ?></span>
                        </td> 
                  <?php } ?>  
                      </tr>
                       <tr>
                           ...
                           <td colspan="7">
                               <small>
                                   ...
                                   <ol type="1" class="list mar_lft30">
                                       <li>Payment will be made as per sales and payment terms, given in the invoice. In the event of delay, intrest @18 % will be charged for the delayed period.</li>
                                       <li>Payment shall be made via RTGS / NEFT / Bank to Bank Transfer
			<br/>
			&nbsp; &nbsp; Bank - ICICI, A/C No - 320205000452, IFSC Code - ICICI0003202
			</li>
                                       <li>Any complaint about material shall be lodged and entertained within 2 working days in writing from the date of receipt of material with respective sales team.</li>
